...
const RecentActivity = () => {
  return (
    <div className=" mt-[40px] lg:mt-[80px] lg:mx-[124px] lg:px-[40px]">
      <h1 className="hidden lg:block text-center text-[#000] text-[] lg:text-[73px] font-[700] font-roboto uppercase">
        Our Recent Activity
      </h1>

      <h1 className=" lg:hidden text-center text-[#000] text-[37px] font-[700] font-roboto uppercase leading-[40px]">
            ...
            <div className="RecentActivitySliderImg flex items-end">
              ...
              <div className=" z-[2] w-full h-full lg:h-[230px] bg-[#00000078] lg:rounded-[29px] opacity-0 hover:opacity-[1] transform duration-300 font-roboto px-[10px] py-[12px] lg:px-[27px] lg:py-[25px]">
                ...
                <p className="text-[11px] lg:text-[15px] text-[#ffffffa1]">
                  ...
                  <span className="hidden lg:block">available, but the majority have suffered alteration in some
                  form, by injected humour, or randomised words</span>
                </p>
