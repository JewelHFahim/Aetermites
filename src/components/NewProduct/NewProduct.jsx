            ...
            <div className=" flex flex-col lg:flex-row justify-between items-center lg:px-[280px] sliderImage mb-[20px]">
              <div className="pt-[57px] lg:pt-[100px]">
                ...
                <h2
                  ...
                  className="text-[73px] lg:text-[150px] text-white leading-[90px] lg:leading-[130px] Richardson "
                >
                  New product
                </h2>
                ...
                <div data-aos-duration="2000"
                  data-aos="zoom-in-up"
                   className="flex flex-col lg:flex-row items-center gap-2 mt-[75px] lg:mt-[20px]">
              ...
              <div data-aos-duration="2000"
                  data-aos="zoom-out-down" className="mb-[-12px] lg:mt-[440px] lg:mr-[160px] z-99]">
                <Button
                  className={` drop-shadow shadow-md shadow-primary ${
                    isDarkmode
