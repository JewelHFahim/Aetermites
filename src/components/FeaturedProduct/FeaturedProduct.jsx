        ...
        <div className="w-full flex justify-center items-center">
          <div className="flex flex-col justify-start px-[49px] lg:px-0">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-[#434343] text-[33px] mt-[10px] lg:mt-0 lg:text-[63px] uppercase leading-[25px] lg:leading-[60px]">
                Products
              </h1>
            </div>

            <p className="text-[#000000ba] text-[11px] lg:text-[15px] mt-[10px] lg:mt-[50px] lg:w-[421px] text-center lg:text-left">
